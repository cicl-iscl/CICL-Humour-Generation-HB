...
def main():
    """
    Main function to set up and run GRPO training for joke generation on DeepSeek-R1-Distill-Qwen-32B.

    This script uses FSDP (via Accelerate) with LoRA for memory-efficient training.
    DeepSeek-R1-Distill-Qwen-32B is based on Qwen2.5-32B architecture.
    ...
    training_args = GRPOConfig(
        ...
        bf16=True,
        push_to_hub=True,
        hub_model_id=f"KonradBRG/DeepSeek-R1-Distill-Qwen-32B-Jokester",
