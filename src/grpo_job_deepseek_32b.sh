#!/bin/bash
#SBATCH --job-name=DeepSeek32B_GRPO
...
# NOTE: This script runs DeepSeek-R1-Distill-Qwen-32B on A100 cluster with FSDP
# Based on Qwen2.5-32B architecture, requires ~64GB VRAM in bf16
# FSDP shards across 4x A100 (320GB total)
...
accelerate launch --config_file accelerate_config_fsdp_32b.yaml \
    train_deepseek_grpo_32b.py \
    --model_id "deepseek-ai/DeepSeek-R1-Distill-Qwen-32B" \
    --output_dir "./checkpoints/deepseek_r1_32b_grpo" \
